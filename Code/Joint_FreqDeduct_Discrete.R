# joint model for claim frequency and deductible choice (discrete model)
...
# Estimated copula parameter (R,N) in Table S.7
cbind(est=zop$par[1],se=se,tau=BiCopPar2Tau(24, zop$par[1]))
